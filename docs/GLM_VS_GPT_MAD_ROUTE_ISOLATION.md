...
- `sks naruto --glm`: blocked. Normal Naruto is Luna/Terra/Sol-only; use the explicitly separate `sks --mad --glm --naruto` route when legacy GLM Naruto is intentionally requested.
