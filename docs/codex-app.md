...
## 1.0.5 Compatibility Notes

Codex CLI/App hook compatibility is pinned to the OpenAI Codex CLI `rust-v0.131.0` baseline. Hook output validation is handled through the vendored generated schemas and runtime semantic validator documented in [codex-cli-compat.md](codex-cli-compat.md).
