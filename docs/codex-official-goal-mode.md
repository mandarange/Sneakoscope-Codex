...
SKS 1.18.1 propagates the official Goal mode reference into every dynamic agent pool generation so refilled workers remain tied to the same continuation contract.
