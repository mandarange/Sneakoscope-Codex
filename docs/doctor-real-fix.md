...
SKS 1.20.3 `sks doctor` reports Codex CLI availability, Codex App readiness, codex-lb health, Zellij dependency readiness, and Codex project config readability separately.
