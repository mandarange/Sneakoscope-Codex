...
SKS 1.19.1 `sks doctor` reports Codex CLI availability, Codex App readiness, codex-lb health, Zellij dependency readiness, and Codex project config readability separately.
