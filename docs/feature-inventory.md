...
- Skills: 1
- Fixture statuses: pass=120, blocked=10, not_required=1
- Feature quality: runtime_verified=98, wiring_only=23, integration_optional=5, static_contract=5, missing=0
...
| `cli-wizard` | core-cli | labs | sks wizard | execute:pass | runtime_verified | none recorded |
...
| `cli-task` | core-cli | labs | sks task run [--sla 5m] [--json] | execute:pass | runtime_verified | none recorded |
| `cli-release` | core-cli | labs | sks release affected\|full\|background [--json] | execute:blocked | runtime_verified | none recorded |
| `cli-triwiki` | core-cli | labs | sks triwiki index\|affected\|proof-bank [--json] | execute:pass | runtime_verified | none recorded |
| `cli-daemon` | core-cli | labs | sks daemon status\|warm\|stop [--json] | execute:pass | runtime_verified | none recorded |
| `cli-run` | core-cli | labs | sks run "task" [--visual\|--research\|--db] [--json] | execute_and_validate_artifacts:blocked | runtime_verified | none recorded |
| `cli-plan` | core-cli | labs | sks plan "task" [--json] | execute:pass | runtime_verified | none recorded |
| `cli-status` | core-cli | labs | sks status [--json] | execute:pass | runtime_verified | none recorded |
| `cli-review` | core-cli | labs | sks review [--staged\|--diff <ref>] [--fix] [--json] | execute:pass | runtime_verified | none recorded |
| `cli-ui` | core-cli | labs | sks ui [--port 4477] [--mission latest] [--once] [--json] | static:pass | static_contract | none recorded |
...
| `cli-bootstrap` | install | labs | sks bootstrap [--install-scope global\|project] [--local-only] [--json] | execute:pass | runtime_verified | none recorded |
| `cli-root` | core-cli | stable | sks root [--json] | execute:pass | runtime_verified | none recorded |
| `cli-update` | core-cli | labs | sks update [check\|now] [--version <version>] [--json] [--dry-run] | execute:pass | runtime_verified | none recorded |
| `cli-uninstall` | core-cli | labs | sks uninstall [--dry-run] [--yes] [--keep-config] [--keep-data] [--purge-projects] [--json] | execute:pass | runtime_verified | none recorded |
| `cli-deps` | install | labs | sks deps check [--json] [--yes] | execute:pass | runtime_verified | none recorded |
...
| `cli-hooks` | integration | beta | sks hooks explain\|status\|trust-report\|replay\|codex-validate\|warning-check ... [--json] | execute:pass | runtime_verified | mobile/event payload details remain unknown |
...
| `cli-zellij` | core-cli | labs | sks zellij status\|repair [--json] \| sks --mad | execute:pass | runtime_verified | none recorded |
| `cli-tmux` | core-cli | labs | removed-runtime migration notice (replacement: zellij) | not_available:not_required | static_contract | none recorded |
...
| `cli-auto-review` | core-cli | labs | sks auto-review status\|enable\|start [--high] \| sks --Auto-review --high | execute:pass | runtime_verified | none recorded |
...
| `cli-commit` | core-cli | labs | sks commit [--message "msg"] [--json] | mock:pass | wiring_only | none recorded |
| `cli-commit-and-push` | core-cli | labs | sks commit-and-push [--message "msg"] [--json] | mock:pass | wiring_only | none recorded |
| `cli-dfix` | core-cli | labs | sks dfix | execute_and_validate_artifacts:pass | runtime_verified | none recorded |
| `cli-qa-loop` | loop | labs | sks qa-loop prepare\|answer\|run\|status ... | execute_and_validate_artifacts:pass | runtime_verified | none recorded |
...
| `cli-init` | install | labs | sks init [--force] [--local-only] [--install-scope global\|project] | execute:pass | runtime_verified | none recorded |
...
| `cli-validate-artifacts` | proof-route | labs | sks validate-artifacts [mission-id\|latest] [--json] | execute_and_validate_artifacts:pass | runtime_verified | none recorded |
...
| `cli-memory` | core-cli | labs | sks memory build [--json] \| sks memory gc [--dry-run] | execute:pass | runtime_verified | none recorded |
| `cli-hproof` | proof-route | labs | sks hproof check [mission-id\|latest] | execute_and_validate_artifacts:pass | runtime_verified | none recorded |
...
| `cli-mcp-server` | core-cli | labs | sks mcp-server [--expose-exec] [--probe] | execute:pass | runtime_verified | none recorded |
| `cli-agent-bridge` | core-cli | labs | sks agent-bridge setup [--json] | execute_and_validate_artifacts:pass | runtime_verified | none recorded |
