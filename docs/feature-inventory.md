...
| `cli-mad` | core-cli | labs | sks --mad [--high] | static:pass | none recorded |
| `cli-auto-review` | core-cli | labs | sks auto-review status\|enable\|start [--high] \| sks --Auto-review --high | static:pass | none recorded |
| `cli-dollar-commands` | core-cli | labs | sks dollar-commands [--json] | static:pass | none recorded |
| `cli-commit` | core-cli | labs | sks commit [--message "msg"] [--json] | static:pass | none recorded |
| `cli-commit-and-push` | core-cli | labs | sks commit-and-push [--message "msg"] [--json] | static:pass | none recorded |
...
| `cli-context7` | integration | labs | sks context7 check\|setup\|tools\|resolve\|docs\|evidence ... | static:pass | none recorded |
...
| `cli-all-features` | core-cli | beta | sks all-features selftest --mock [--json] | static:pass | feature fixtures remain progressive |
...
| `cli-profile` | core-cli | labs | sks profile show\|set <model> | static:pass | none recorded |
...
| `handler-$` | internal | beta | sks $ | static:pass | hidden handler docs needed if promoted |
| `handler-autoresearch` | internal | beta | sks autoresearch | static:pass | hidden handler docs needed if promoted |
| `handler-autoreview` | internal | beta | sks autoreview | static:pass | hidden handler docs needed if promoted |
| `handler-computer-use` | internal | beta | sks computer-use | static:pass | hidden handler docs needed if promoted |
| `handler-cu` | internal | beta | sks cu | static:pass | hidden handler docs needed if promoted |
| `handler-dollars` | internal | beta | sks dollars | static:pass | hidden handler docs needed if promoted |
| `handler-mad-sks` | internal | beta | sks mad-sks | static:pass | hidden handler docs needed if promoted |
| `handler-postinstall` | internal | beta | sks postinstall | static:pass | hidden handler docs needed if promoted |
...
| `skill-db-safety-guard` | skill | labs | $db-safety-guard | static:pass | runtime fixtures owned by route |
| `skill-design-artifact-expert` | skill | labs | $design-artifact-expert | static:pass | runtime fixtures owned by route |
| `skill-design-system-builder` | skill | labs | $design-system-builder | static:pass | runtime fixtures owned by route |
| `skill-design-ui-editor` | skill | labs | $design-ui-editor | static:pass | runtime fixtures owned by route |
| `skill-getdesign-reference` | skill | labs | $getdesign-reference | static:pass | runtime fixtures owned by route |
| `skill-gx-visual-generate` | skill | labs | $gx-visual-generate | static:pass | runtime fixtures owned by route |
| `skill-gx-visual-read` | skill | labs | $gx-visual-read | static:pass | runtime fixtures owned by route |
| `skill-gx-visual-validate` | skill | labs | $gx-visual-validate | static:pass | runtime fixtures owned by route |
| `skill-honest-mode` | skill | labs | $honest-mode | static:pass | runtime fixtures owned by route |
| `skill-hproof-claim-ledger` | skill | labs | $hproof-claim-ledger | static:pass | runtime fixtures owned by route |
| `skill-hproof-evidence-bind` | skill | labs | $hproof-evidence-bind | static:pass | runtime fixtures owned by route |
| `skill-imagegen` | skill | labs | $imagegen | static:pass | runtime fixtures owned by route |
| `skill-performance-evaluator` | skill | labs | $performance-evaluator | static:pass | runtime fixtures owned by route |
| `skill-pipeline-runner` | skill | labs | $pipeline-runner | static:pass | runtime fixtures owned by route |
| `skill-prompt-pipeline` | skill | labs | $prompt-pipeline | static:pass | runtime fixtures owned by route |
| `skill-ralph` | skill | labs | $ralph | static:pass | runtime fixtures owned by route |
| `skill-ralph-resolver` | skill | labs | $ralph-resolver | static:pass | runtime fixtures owned by route |
| `skill-ralph-supervisor` | skill | labs | $ralph-supervisor | static:pass | runtime fixtures owned by route |
| `skill-reasoning-router` | skill | labs | $reasoning-router | static:pass | runtime fixtures owned by route |
| `skill-reflection` | skill | labs | $reflection | static:pass | runtime fixtures owned by route |
| `skill-research-discovery` | skill | labs | $research-discovery | static:pass | runtime fixtures owned by route |
| `skill-seo-geo-optimizer` | skill | labs | $seo-geo-optimizer | static:pass | runtime fixtures owned by route |
| `skill-solution-scout` | skill | labs | $solution-scout | static:pass | runtime fixtures owned by route |
| `skill-turbo-context-pack` | skill | labs | $turbo-context-pack | static:pass | runtime fixtures owned by route |
