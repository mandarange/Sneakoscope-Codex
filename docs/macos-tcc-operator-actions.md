...
In SKS 1.20.4, when Codex reports `Operation not permitted (os error 1)` while Node can read `.codex/config.toml`, SKS treats macOS TCC as a probable diagnosis, not a certain one.
