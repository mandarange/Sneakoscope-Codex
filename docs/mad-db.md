...
`$MAD-SKS` and `sks --mad` do not create a MadDB capability. They keep the ordinary catastrophic DB safeguards active. Use the first-class MadDB route for destructive SQL-plane work.
