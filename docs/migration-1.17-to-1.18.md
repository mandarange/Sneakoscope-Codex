...
2. Run `npm run build`.
3. Run the new 1.18.0 gates: `npm run source-intelligence:all-modes`, `npm run agent:background-terminals`, `npm run agent:tmux-right-lanes`, and `npm run release:parallel-full-coverage`.
