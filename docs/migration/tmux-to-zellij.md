...
- Use `sks naruto dashboard latest` for new Naruto lane state; `sks team open-zellij` and `sks team attach-zellij` remain legacy helpers for old Team cockpit lanes only.
