...
SKS 1.18.1 extends that DAG with dynamic agent pool replenishment, backfill, session generation, generation-aware terminal, real/fake tmux pane evidence, cockpit, Source Intelligence propagation, and Goal mode propagation gates.
