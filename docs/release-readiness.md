...
SKS 3.1.14 is the release-metadata alignment patch after 3.1.13. It keeps the Codex 0.140 production-hardening surface intact while requiring package, lockfile, CLI constants, Rust helper metadata, docs, built output, release stamp, provenance, and npm registry unpublished-version checks to agree on 3.1.14 before publication.
