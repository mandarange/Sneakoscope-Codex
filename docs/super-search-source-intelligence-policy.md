...
Super-Search is the public source-intelligence command for SKS. It decomposes queries, selects source lanes by capability, records typed artifacts, normalizes sources, separates weak discovery from verified content, and builds claim/citation proof without requiring provider-specific credentials.
