...
2. Send that screenshot to gpt-image-2.5-sunburst with a senior Toss UI/UX designer I2I brief. The generated image must annotate P0–P3 issues, hierarchy, contrast, density, affordance, eye flow, and a mini-comp; prose alone is invalid.
