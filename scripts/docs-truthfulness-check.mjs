...
const required = {
  ...
  'docs/codex-cli-compat.md': ['rust-v0.134.0', 'profile_primary_selector', 'managed_network_proxy_env', 'goals_default_enabled', 'permission_profiles_requirements', 'SubagentStart', 'sks_zero_warning_disallowed', 'strict subset'],
  'docs/official-docs-compat.md': ['official-docs:compat', 'rust-v0.134.0', 'gpt-image-2', 'input_fidelity', 'additionalProperties:false'],
