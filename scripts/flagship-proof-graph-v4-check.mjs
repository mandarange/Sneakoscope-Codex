...
const dependencies = [
  ['flagship-proof-graph-v3.json', './scripts/flagship-proof-graph-v3-check.mjs'],
  ['mad-sks-actual-executor-blackbox.json', './scripts/mad-sks-actual-executor-blackbox.mjs'],
  ['mad-sks-file-write-executor.json', './scripts/mad-sks-file-write-executor-check.mjs'],
  ['mad-sks-shell-executor.json', './scripts/mad-sks-shell-executor-check.mjs'],
  ['mad-sks-package-executor.json', './scripts/mad-sks-package-executor-check.mjs'],
  ['mad-sks-service-executor.json', './scripts/mad-sks-service-executor-check.mjs'],
  ['mad-sks-db-executor.json', './scripts/mad-sks-db-executor-check.mjs'],
  ['mad-sks-rollback-apply.json', './scripts/mad-sks-rollback-apply-check.mjs'],
  ['mad-sks-live-protected-core-smoke.json', './scripts/mad-sks-live-protected-core-smoke.mjs'],
  ['mad-sks-executor-proof-graph.json', './scripts/mad-sks-executor-proof-graph-check.mjs']
];
