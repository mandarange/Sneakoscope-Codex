...
const jsonPath = path.join(reportDir, 'official-docs-compat-1.10.0.json');
const mdPath = path.join(reportDir, 'official-docs-compat-1.10.0.md');
...
function renderMarkdown(report) {
  const lines = [
    '# SKS 1.10.0 Official Docs Compatibility',
    '',
