...
const jsonPath = path.join(reportDir, 'official-docs-compat-1.0.9.json');
const mdPath = path.join(reportDir, 'official-docs-compat-1.0.9.md');
...
function renderMarkdown(report) {
  const lines = [
    '# SKS 1.0.9 Official Docs Compatibility',
    '',
