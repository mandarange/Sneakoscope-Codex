...
export function buildDecisionContract({ mission, schema, answers, mistakeRecall = null }: any) {
  ...
  const contract: any = {
    ...
    hard_constraints: {
      ...
      qa_loop_ui_requires_codex_chrome_extension_first: Boolean(answers.QA_SCOPE && answers.QA_SCOPE !== 'api_e2e_only'),
      qa_loop_native_non_web_visual_requires_codex_computer_use_only: false,
