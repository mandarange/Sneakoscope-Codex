...
import { runSksUpdateCheck } from './update-check.mjs';
import { scanAgentTextForRecursion } from './agents/agent-recursion-guard.mjs';
import {
...
} from './codex-compat/codex-hook-output-builders.mjs';
...
function agentWorkerHookContext(state = {}, payload = {}) {
  const env = {
    ...(payload.env || {}),
