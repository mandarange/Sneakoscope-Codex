...
const AGENTS_BLOCK = [
  ...
  '- Use the current context pack for TriWiki recall when a claim needs project memory. Hydrate stale or risky claims from source, refresh after material changes, and validate before handoff or final.',
