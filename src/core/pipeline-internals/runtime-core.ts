...
import { FIVE_SCOUT_STAGE_ID, SCOUT_COUNT } from '../scouts/scout-schema.js';
import { normalizeScoutPolicy, routeRequiresScoutIntake, scoutPipelineStage } from '../scouts/scout-plan.js';
