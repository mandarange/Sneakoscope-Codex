...
export const COMMAND_CATALOG = [
  ...
  { name: 'hooks', usage: 'sks hooks explain|status|trust-report|replay|codex-validate|warning-check ... [--json]', description: 'Explain Codex hook events, validate vendored rust-v0.131.0 output schemas, replay fixtures, and enforce warning-zero SKS hook policies under the 0.132 compatibility matrix.' },
