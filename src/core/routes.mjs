...
export const COMMAND_CATALOG = [
  ...
  { name: 'codex', usage: 'sks codex compatibility|version|doctor|schema [--json]', description: 'Check Codex CLI rust-v0.132.0 compatibility, installed version, 0.132 capabilities, and vendored hook schema snapshot freshness.' },
  ...
  { name: 'hooks', usage: 'sks hooks explain|status|trust-report|replay|codex-validate|warning-check ... [--json]', description: 'Explain Codex hook events, validate vendored latest 10-event output schemas, replay fixtures, and enforce warning-zero SKS hook policies under the 0.132 compatibility matrix.' },
