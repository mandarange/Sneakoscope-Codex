...
export const COMMAND_CATALOG = [
  ...
  { name: 'agent', usage: 'sks agent run|status <mission-id|latest> [--agents N] [--work-items N] [--target-active-slots N] [--mock] [--json]', description: 'Run or inspect native multi-session agent missions with agents as target active slots and work items as the route queue size.' },
