...
const DOLLAR_COMMANDS_LITE_BASE = [
  ...
  { command: '$Image-UX-Review', route: 'image-generation UI/UX review loop', description: ("Review UI/UX through the imagegen visual critique loop: source screenshots become generated annotated review images, those images become issue ledgers, then fixes are rechecked.") },
