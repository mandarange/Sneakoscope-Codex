...
export const DOLLAR_COMMANDS_LITE = [
  ...
  { command: '$Plan', route: 'planning-only frontdoor', description: 'Decision-complete planning only. Writes .sneakoscope/plans/<slug>.md and keeps implementation disallowed until $Work runs the plan.' },
  ...
  { command: '$SEO-GEO-OPTIMIZER', route: 'search visibility optimization audit/apply/verify', description: 'Unified SEO/GEO optimizer route for Search Engine Optimization and Generative Engine Optimization. Uses one shared kernel with mode-specific evidence, gates, safe apply, rollback, and Completion Proof. Not a ranking, traffic, or AI citation guarantee.' },
...
export const DOLLAR_COMMAND_ALIASES_LITE = [
  ...
  { canonical: '$Team', app_skill: '$team' },
  { canonical: '$Team', app_skill: '$from-chat-img' },
