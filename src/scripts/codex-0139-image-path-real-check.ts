...
const result = await mod.runCodex0139ImageReferencedPathRealProbe({ root, requireReal: true, timeoutMs: Number(process.env.SKS_CODEX_0139_REAL_PROBE_TIMEOUT_MS || 120000), codexBin })
