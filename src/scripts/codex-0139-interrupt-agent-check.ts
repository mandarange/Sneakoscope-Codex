...
assertGate(currentClose.canonical === 'close_agent' && currentClose.stage === 'result', '0.144.5 closeAgent must map to result stage', currentClose)
assertGate(currentStart.canonical === 'start_agent' && currentStart.stage === 'start', '0.144.5 spawnAgent must map to start stage', currentStart)
