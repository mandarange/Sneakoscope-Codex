...
const tasks: VerificationTask[] = [
  ...
  task('super-search:provider-interface', 'npm run super-search:provider-interface --silent', { dependencies: ['build'] }),
  task('source-intelligence:policy', 'npm run source-intelligence:policy --silent', { dependencies: ['build'] }),
  task('source-intelligence:all-modes', 'npm run source-intelligence:all-modes --silent', { dependencies: ['build', 'source-intelligence:policy', 'super-search:provider-interface', 'codex-web:adapter'] }),
  ...
  task('legacy:gate-purge', 'node ./dist/scripts/legacy-gate-purge-check.js', { dependencies: ['build'] }),
  task('legacy:gate-inventory', 'node ./dist/scripts/legacy-gate-inventory-check.js', { dependencies: ['legacy:gate-purge'] }),
  task('legacy:strong-inventory', 'node ./dist/scripts/legacy-strong-inventory-check.js', { dependencies: ['legacy:gate-inventory'] }),
  task('migration:upgrade-safety', 'npm run migration:upgrade-safety --silent', { dependencies: ['legacy:strong-inventory'] }),
  ...
  task('safety:mutation-callsite-coverage', 'node ./dist/scripts/mutation-callsite-coverage-check.js', { dependencies: ['build'] }),
