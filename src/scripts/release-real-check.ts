...
const tasks = [
  ...
  task('codex:0139-real-probes:require-real', 'codex:0139-real-probes:require-real', { group: 'environment_required', phase: 'parallel_processing' }),
  task('codex:0139-code-mode-web-search-real', 'codex:0139-code-mode-web-search-real', { group: 'environment_required', phase: 'parallel_processing', deps: ['codex:0139-real-probes:require-real'] }),
  task('codex:0139-rich-tool-schema-real', 'codex:0139-rich-tool-schema-real', { group: 'environment_required', phase: 'parallel_processing', deps: ['codex:0139-real-probes:require-real'] }),
  task('codex:0139-doctor-env-real', 'codex:0139-doctor-env-real', { group: 'environment_required', phase: 'parallel_processing', deps: ['codex:0139-real-probes:require-real'] }),
  task('codex:0139-plugin-marketplace-real', 'codex:0139-plugin-marketplace-real', { group: 'environment_required', phase: 'parallel_processing', deps: ['codex:0139-real-probes:require-real'] }),
  task('codex:0139-plugin-cache-real', 'codex:0139-plugin-cache-real', { group: 'environment_required', phase: 'parallel_processing', deps: ['codex:0139-real-probes:require-real'] }),
  task('codex:0139-sandbox-profile-alias-real', 'codex:0139-sandbox-profile-alias-real', { group: 'environment_required', phase: 'parallel_processing', deps: ['codex:0139-real-probes:require-real'] }),
