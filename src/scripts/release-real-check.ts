...
const tasks = [
  ...
  task('publish:dry-run-performance', 'publish:dry-run-performance', { group: 'environment_required', phase: 'parallel_processing', policy: requiredPolicy(['sks.npm-publish-performance.v1', 'sks.release-gate.v1']) }),
  ...
  task('agent:real-codex-parallel-workers-5', 'direct', { command: nodeScript('agent-real-codex-parallel-workers-5-check.js'), group: 'real_smoke', phase: 'parallel_processing', policy: liveOptionalPolicy(['sks.release-gate.v1', 'sks.real-codex-parallel-gate.v1']) }),
