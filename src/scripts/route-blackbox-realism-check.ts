...
assertGate(releaseGateIds.has('dfix:fixture'), 'DFix route fixture gate must exist');
assertGate(releaseGateIds.has('ppt:full-e2e-blackbox'), 'PPT route blackbox gate must exist');
assertGate(releaseGateIds.has('ux-review:imagegen-blackbox'), 'UX route blackbox gate must exist');
