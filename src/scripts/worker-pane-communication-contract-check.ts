...
await fs.writeFile(path.join(badRoot, 'native-cli-worker-runtime.json'), '{"records":[{"worker_artifact_dir":"worker","scaling_primitive":"native_cli_process_in_zellij_worker_pane"}]}\n')
