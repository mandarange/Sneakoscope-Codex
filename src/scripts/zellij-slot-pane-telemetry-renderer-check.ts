...
assertGate(pane.includes('artifactFallbackRows') && pane.includes('renderZellijSlotPaneFromArtifactDir'), 'slot pane renderer must preserve artifact/log fallback when telemetry is stale')
