...
assertGate(pane.includes('artifactFallbackRows') && pane.includes('renderZellijSlotPaneFromArtifactDir'), 'slot pane must merge telemetry with artifact/log fallback instead of stale-only output')
