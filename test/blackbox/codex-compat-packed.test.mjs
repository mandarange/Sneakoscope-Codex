...
test('packed Codex compatibility includes schema snapshot and semantic status', async () => {
  ...
  assert.equal(json.legacy_baselines?.codex_0_135?.superseded_by, 'rust-v0.136.0');
  assert.equal(json.legacy_baselines?.codex_0_134?.superseded_by, 'rust-v0.136.0');
  assert.equal(json.legacy_baselines?.codex_0_133?.superseded_by, 'rust-v0.136.0');
  assert.equal(json.legacy_baselines?.codex_0_132?.superseded_by, 'rust-v0.136.0');
});
