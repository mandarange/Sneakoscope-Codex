...
const scripts = [
  ['dist/scripts/blackbox-pack-install.js', 'sks.blackbox-pack-install.v1', ['npm_pack', 'npm_install_tarball', 'npx_sks_version', 'npx_sks_root_json', 'npx_sks_setup_local_only', 'npx_sks_selftest_mock', 'npx_sks_run_execute_mock', 'npx_sks_agent_mock', 'npx_sks_qa_loop_prepare', 'npx_sks_qa_loop_run_mock', 'verify_completion_proof_exists']],
