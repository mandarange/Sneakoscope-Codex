...
test('UX-Review proof/trust packed path blocks mock-as-real', () => {
  const report = buildTrustReport({
    proof: { mission_id: 'M-packed', route: '$Image-UX-Review', status: 'verified', evidence: { image_ux_review: { generated_images_total: 1, generated_imagegen_callout_images_count: 0, blockers: [] } } },
