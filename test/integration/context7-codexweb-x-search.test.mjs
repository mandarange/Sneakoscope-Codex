...
test('source intelligence proof rejects missing UltraSearch proof instead of requiring xAI', () => {
  ...
  assert.ok(proof.blockers.includes('ultra_search_provider_independent_proof_missing'));
