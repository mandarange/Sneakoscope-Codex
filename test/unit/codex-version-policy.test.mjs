...
test('Codex version policy accepts rust-v0.131.0 or newer', () => {
  assert.equal(parseCodexVersionText('codex-cli 0.131.0'), '0.131.0');
  assert.equal(compareSemverLike('0.132.0', '0.131.0'), 1);
  assert.equal(codexVersionPolicy({ available: true, version: '0.131.0', source: 'fixture' }).status, 'ok');
});
